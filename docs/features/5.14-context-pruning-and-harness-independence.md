# Feature Specification: Context Pruning & Harness Independence

## 1. Overview
Tài liệu này đặc tả hai cơ chế nâng cao nhằm tối ưu hóa bộ điều phối (Orchestrator) của Auto Code OS, được đúc kết từ kiến trúc của Aider và AI-SDLC:
...
## 2. Feature 1: Binary Search Token Pruning & PageRank Personalization
...
## 3. Feature 2: Harness Independence (Model Review Isolation)
