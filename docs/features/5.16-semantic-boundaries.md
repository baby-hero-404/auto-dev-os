# Feature Specification: Semantic Boundaries & Filesystem RBAC

## 1. Overview
Tài liệu này đặc tả cơ chế phân quyền hệ thống file (Filesystem RBAC) cho các AI Agent trong Auto Code OS, chuyển dịch từ mô hình "danh sách trắng tĩnh" (Static ACL) sang **Biên giới Ngữ nghĩa (Semantic Boundaries)**.
...
## 2. Feature 1: Semantic Capabilities & RBAC
...
## 3. Feature 2: Just-In-Time (JIT) Expansion & Risk Evaluation
