...
- [x] 1.7 UI Audit panel + verify badge (REQ-005) — Done: `AuditPanel` implemented in `TaskDetailLayout.tsx` and `TaskTitleBlock.tsx` includes a top-level Verified badge.
...
- [x] Update corresponding `docs/features/` as specified in feature-docs-sync/design.md — done 2026-07-23: product/09, product/05
