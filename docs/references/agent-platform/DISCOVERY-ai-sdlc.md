...
## Tổng Quan (TL;DR)
AI-SDLC là một hệ thống giúp AI tự viết code một cách đáng tin cậy, bằng cách bắt buộc mọi yêu cầu phải được mô tả thật rõ ràng trước khi AI được phép bắt tay vào làm, và bắt buộc phải có một AI khác (độc lập) kiểm tra lại kết quả trước khi merge. Nó giống như một quy trình sản xuất có nhiều trạm kiểm soát chất lượng, thay vì để một mình AI vừa làm vừa tự chấm điểm cho chính mình.
