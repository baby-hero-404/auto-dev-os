...
func TestWriteLLMCallTrace_ChronologicalFormat(t *testing.T) {
	...
	orch.writeLLMCallTrace(ctx, task, agent, "plan", messages, resp, parsed, llmrunner.TraceCounters{Iteration: 1}, time.Millisecond)
	...
	orch.writeLLMCallTrace(ctx, task, agent, "code", messages, resp, parsed, llmrunner.TraceCounters{Iteration: 1}, time.Millisecond)
	...
	orch.writeLLMCallTrace(ctx, task, agent, "review", messages, resp, parsed, llmrunner.TraceCounters{Iteration: 1}, time.Millisecond)
	...
	orch.writeLLMCallTrace(ctx, task, agent, "fix", messages, resp, parsed, llmrunner.TraceCounters{Iteration: 1}, time.Millisecond)
