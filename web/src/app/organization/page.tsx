        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="rounded-lg border border-stroke bg-card p-5">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between items-center rounded-md border border-stroke bg-surface p-3">
              ...
              <div className="flex justify-between items-center rounded-md border border-stroke bg-surface p-3">
                ...
                <span className="font-mono text-xs text-content-muted truncate max-w-[200px]" title={orgID}>{orgID || "—"}</span>
              </div>
              <div className="flex justify-between items-center rounded-md border border-stroke bg-surface p-3">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border border-dashed border-stroke bg-surface/50 p-5">
              <div className="mb-3 flex items-center gap-2">
