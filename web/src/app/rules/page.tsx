...
export default function RulesPage() {
  ...
  return (
    <DashboardLayout>
      ...
      <div className="mt-6 rounded-lg border border-[var(--border)] bg-[var(--primary)] p-5">
        ...
        <ul className="space-y-3 text-sm text-slate-300">
          <li className="flex items-start gap-3 rounded-md border border-[var(--border)] bg-slate-950 p-3">
