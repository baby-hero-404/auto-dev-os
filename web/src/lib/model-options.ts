export const AGENT_ROLES = ["planner", "backend", "frontend", "mobile-developer", "reviewer", "qa", "security-auditor", "db-architect", "documentation-writer"] as const;
...
export const PROVIDERS = ["gateway", "openai", "anthropic", "gemini", "9router", "cli:claude", "cli:codex", "cli:antigravity"] as const;
